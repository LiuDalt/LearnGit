...
import com.example.learnmedia.InputSurface;
import com.example.learnmedia.OutputSurface;
 ...
 */
@TargetApi(18)
public class ExtractDecodeEditEncodeMuxTest2 extends AndroidTestCase {
    private static final String TAG = ExtractDecodeEditEncodeMuxTest2.class.getSimpleName();
    ...
    private static class TestWrapper implements Runnable {
        ...
        private ExtractDecodeEditEncodeMuxTest2 mTest;
        private TestWrapper(ExtractDecodeEditEncodeMuxTest2 test) {
            mTest = test;
        }
        @Override
        public void run() {
         ...
         * Entry point.
         */
        public static void runTest(ExtractDecodeEditEncodeMuxTest2 test) throws Throwable {
            test.setOutputFile();
    ...
    private void setOutputFile() {
        ...
        sb.append(Environment.getExternalStorageDirectory().getAbsolutePath() +"/00temp/copy-");
        if (mCopyVideo) {
            sb.append("video");
            sb.append('-');
            sb.append(mWidth);
        ...
        Log.i("outputfile___", "path=" + sb.toString());
    }
    /**
    ...
    private MediaExtractor createExtractor() throws IOException {
        ...
        extractor.setDataSource(Environment.getExternalStorageDirectory().getAbsolutePath() + "/00temp/a.mp4");
        return extractor;
    }
    /**
